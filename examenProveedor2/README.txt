...
a persistence unit "examenProveedor2PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examenProveedor2\pom.xml":
...
artifact ("examenProveedor2.war") is already built. You can build
